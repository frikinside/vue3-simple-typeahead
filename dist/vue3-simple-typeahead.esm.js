import { defineComponent, openBlock, createElementBlock, withDirectives, createElementVNode, mergeProps, withKeys, withModifiers, vModelText, renderSlot, createCommentVNode, Fragment, renderList, normalizeClass } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    onKeydown: [_cache[4] || (_cache[4] = withKeys(withModifiers(function () {
      return _ctx.onArrowDown && _ctx.onArrowDown(...arguments);
    }, ["prevent"]), ["down"])), _cache[5] || (_cache[5] = withKeys(withModifiers(function () {
      return _ctx.onArrowUp && _ctx.onArrowUp(...arguments);
    }, ["prevent"]), ["up"])), _cache[6] || (_cache[6] = withKeys(withModifiers(function () {
      return _ctx.selectCurrentSelection && _ctx.selectCurrentSelection(...arguments);
    }, ["prevent"]), ["enter"])), _cache[7] || (_cache[7] = withKeys(withModifiers(function () {
      return _ctx.selectCurrentSelectionTab && _ctx.selectCurrentSelectionTab(...arguments);
    }, ["prevent"]), ["tab"]))],
    autocomplete: "off"

<template>
  <div :id="wrapperId" class="simple-typeahead">
    ...
    <div v-if="isListVisible" class="simple-typeahead-list">
      <div class="simple-typeahead-list-header" v-if="$slots.listHeader">
      ...
      >
        <span class="simple-typeahead-list-item-text" :data-text="itemProjection(item)" v-if="$slots.listItemText"
      ...
      <div class="simple-typeahead-list-footer" v-if="$slots.listFooter"><slot name="list-footer"></slot></div>
    </div>
  </div>
</template>
